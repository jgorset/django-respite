# -*- coding: utf-8 -*-
#
# Respite documentation build configuration file, created by
# sphinx-quickstart on Mon Aug  8 15:19:28 2011.
#
...
latex_documents = [
  ('index', 'Respite.tex', u'Respite Documentation',
...
man_pages = [
    ('index', 'respite', u'Respite Documentation',
     [u'Johannes Gorset'], 1)
]
